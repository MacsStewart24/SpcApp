...
package com.example.smartpowerconnector_room.data.allRoutine.offline

import com.example.smartpowerconnector_room.data.allRoutine.multi.MultiRoutine
import com.example.smartpowerconnector_room.data.allRoutine.multi.MultiRoutineDao
import com.example.smartpowerconnector_room.data.allRoutine.multi.MultiRoutineRepository
import kotlinx.coroutines.flow.Flow

class OfflineMultiRoutineRepository(private val MultiRoutineDao: MultiRoutineDao) :
    MultiRoutineRepository {
