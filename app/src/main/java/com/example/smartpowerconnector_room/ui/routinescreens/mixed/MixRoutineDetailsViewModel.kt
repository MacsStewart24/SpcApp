...
import com.example.inventory.ui.routines.MixRoutineDetailsDestination
...
class MixRoutineDetailsViewModel(
    ...
    private val MixRoutineRepository: MixRoutineRepository, val itemsRepository: DeviceRepository
) : ViewModel() {
